...
<% 
	...
	if((action = request.getParameter("action")) != null){
		...
		response.sendRedirect("posterB.jsp");
	}
	
	List<Task> taskList = taskService.findPersonalTasks("posterB");
	
%>
<h1 class="col-md-offset-1">welcome posterB</h1>
...
%>
	    <tr>
	      ...
	      <td><a href="posterB.jsp?action=pass&id=<%=task.getId() %>">finished</a></td>
	    </tr>
<%
	}
%>
