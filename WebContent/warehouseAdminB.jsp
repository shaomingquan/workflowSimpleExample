...
<% 
	...
	if((action = request.getParameter("action")) != null){
		...
		response.sendRedirect("warehouseAdminB.jsp");
	}
	
	List<Task> taskList = taskService.findPersonalTasks("warehouseAdminB");
	
%>
<h1 class="col-md-offset-1">welcome warehouseAdminB</h1>
...
%>
	    <tr>
	      ...
	      <td><a href="warehouseAdminB.jsp?action=pass&id=<%=task.getId() %>">pass</a></td>
	    </tr>
<%
	}
%>
