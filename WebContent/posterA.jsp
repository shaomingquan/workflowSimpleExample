...
<% 
	...
	if((action = request.getParameter("action")) != null){
		...
		response.sendRedirect("posterA.jsp");
	}
	
	List<Task> taskList = taskService.findPersonalTasks("posterA");
	
%>
<h1 class="col-md-offset-1">welcome posterA</h1>
...
%>
	    <tr>
	      ...
	      <td><a href="posterA.jsp?action=pass&id=<%=task.getId() %>">pass</a></td>
	    </tr>
<%
	}
%>
