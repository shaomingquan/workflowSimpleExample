...
<% 
	...
	if((action = request.getParameter("action")) != null){
		...
		response.sendRedirect("warehouseAdminA.jsp");
	}
	
	List<Task> taskList = taskService.findPersonalTasks("warehouseAdminA");
	
%>
<h1 class="col-md-offset-1">welcome warehouseAdminA</h1>
...
%>
	    <tr>
	      ...
	      <td><a href="warehouseAdminA.jsp?action=pass&id=<%=task.getId() %>">pass</a></td>
	    </tr>
<%
	}
%>
